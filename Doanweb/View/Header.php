            ...
            <div  class="row">
                ...
                <div style="background-color: #808080; font-weight: bold;"class="navbar-collapse collapse">
                    <ul type="disc" class="nav navbar-nav">
                        ...
                        <li><a style="color: #fff" href="index.php?mod=products&act=allproducts" onclick="return isActive()">Sản Phẩm</a></li>
                        <li><a style="color: #fff" href="index.php?mod=products&act=detail">Chi Tiết</a></li>
                        <!--<li><a href="index.php?mod=cart&act=detail">Giỏ Hàng</a></li>-->
                        <li class="dropdown">
                            <a style="color: #fff" href="#" class="dropbtn">Phân Loại</a>
                        ...
                        <li class="dropdown">
                            <a style="color: #fff" href="#" class="dropbtn">Hãng SX</a>
                            <div class="dropdown-content">
