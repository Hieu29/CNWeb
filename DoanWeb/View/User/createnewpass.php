<div style="width: 500px;margin: 0 auto; margin-top: 20px;border: 5px double">
    ...
    <p>
        <form action="index.php?mod=user&act=updatepass" method="post" class="form" onSubmit="return IsChangePass()">
    <p style="margin-left: 88px"><label>Name</label><input type="text" name="txtOldname" id="txtOldPass" placeholder="Cần xát nhận chính chủ" style="margin-left:55px;"/></p>
