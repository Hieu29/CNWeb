	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="index.php?mod=user&act=login" onsubmit="return IsLogin();">
     ...
     <form method="post" action="index.php?mod=user&act=login" onsubmit="return IsLogin();" class="form">
        ...
        <p id="error"></p>
					...
					<div class="login100-form-social flex-c-m">
						<a href="<?php echo $loginURL ?>" class="login100-form-social-item flex-c-m bg1 m-r-5">
